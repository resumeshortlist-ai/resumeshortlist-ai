...
export default function AppClient() {
  ...
  function verdictFor(scoreNum: number): Verdict {
    if (scoreNum < 55) {
      return {
  ...
  const scoreNumber = typeof score?.score === "number" ? score.score : null;
  const showResults = !!score?.ok && scoreNumber !== null;
  ...
  return (
    <main className="section">
      <div className="container">
        ...
        <p className="p">
          This assessment estimates performance across <b>ATS screening</b>,{" "}
          <b>recruiter triage</b>, and internal review layers — not how it reads
          to you.
        </p>
          ...
          <div className="card">
            <div className="grid2">
              <div>
                ...
                <p className="muted">
                  PDF or DOCX. You’ll receive a score, a clear verdict, and 3–4
                ...
                <div className="form">
                  ...
                  {/* TS-safe error render (fixes 'never' issue) */}
              ...
              <div className="calloutSoft">
                ...
                <p className="muted">
                  Hiring filters tighten during competitive cycles. Your resume
                  is evaluated across automated screeners, recruiter scan
                  patterns, manager review, HR checks, and approvals. Resumes not
                  rebuilt with intention are filtered out silently.
                </p>
                <p className="muted">
                  <b>
                    When was the last time you rebuilt your resume with
                    intention — not quick edits?
                  </b>
                </p>
              </div>
            </div>
        ...
        {/* Results */}
        {showResults && scoreNumber !== null && (
          <div className="resultsGrid">
            <div>
              <div className="card">
                {(() => {
                  const v = verdictFor(scoreNumber);
                  return (
                    <>
              ...
              <div className="card">
                <div className="row">
                  <div>
                    ...
                    <div className="score">{scoreNumber}/100</div>
                    <div className="muted">
                      This score suggests how your resume performs through
                      parsing, ranking, and scan patterns.
                    </div>
                  </div>
                  ...
                  <div className="scoreBarWrap">
                    <div
                      className="scoreBar"
                      style={{
                        width: `${Math.min(100, Math.max(0, scoreNumber))}%`
                      }}
                    />
                  </div>
                </div>
              ...
              <div className="card">
                ...
                <div className="muted">
                  These are the highest-impact corrections to improve shortlist
                  probability.
                </div>
              ...
              <div className="callout">
                ...
                <p className="p">
                  Organizations are relying more heavily on automated filters,
                  resume rankers, and recruiter pattern recognition to manage
                  volume. Your resume is evaluated long before interviews are
                  discussed — across multiple companies, each with different
                  thresholds.
                </p>
                <p className="p">
            ...
            <aside className="sidePanel">
              ...
              <div className="muted">
                24-hour first delivery · 2 revision cycles · finalized within 5
                days
              </div>
